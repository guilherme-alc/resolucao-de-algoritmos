    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                {
                    {"UUU", "Fenilalanina"},{"UUC", "Fenilalanina"},{"UUA", "Leucina"},
                    {"UUG", "Leucina"},{"UCU", "Serina"},{"UCC", "Serina"},
                    {"UCA", "Serina"},{"UCG", "Serina"},{"UAU", "Tirosina"},
                    {"UAC", "Tirosina"},{"UAA", "Parada"},{"UAG", "Parada"},
                    {"UGU", "Cisteína"},{"UGC", "Cisteína"},{"UGA", "Parada"},
                    {"UGG", "Triptofano"},{"CUU", "Leucina"},{"CUC", "Leucina"},
                    {"CUA", "Leucina"},{"CUG", "Leucina"},{"CCU", "Prolina"},
                    {"CCC", "Prolina"},{"CCA", "Prolina"},{"CCG", "Prolina"},
                    {"CAU", "Histidina"},{"CAC", "Histidina"},{"CAA", "Glutamina"},
                    {"CAG", "Glutamina"},{"CGU", "Arginina"},{"CGC", "Arginina"},
                    {"CGA", "Arginina"},{"CGG", "Arginina"},{"AUU", "Isoleucina"},
                    {"AUC", "Isoleucina"},{"AUA", "Isoleucina"},{"AUG", "Metionina"},
                    {"ACU", "Treonina"},{"ACC", "Treonina"},{"ACA", "Treonina"},
                    {"ACG", "Treonina"},{"AAU", "Asparagina"},{"AAC", "Asparagina"},
                    {"AAA", "Lisina"},{"AAG", "Lisina"},{"AGU", "Serina"},
                    {"AGC", "Serina"},{"AGA", "Arginina"},{"AGG", "Arginina"},
                    {"GUU", "Valina"},{"GUC", "Valina"},{"GUA", "Valina"},
                    {"GUG", "Valina"},{"GCU", "Alanina"},{"GCC", "Alanina"},
                    {"GCA", "Alanina"},{"GCG", "Alanina"},{"GAU", "Aspartato"},
                    {"GAC", "Aspartato"},{"GAA", "Glutamato"},{"GAG", "Glutamato"},
                    {"GGU", "Glicina"},{"GGC", "Glicina"},{"GGA", "Glicina"},
                    {"GGG", "Glicina"},
                };
